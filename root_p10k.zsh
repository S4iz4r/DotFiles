# Generated by Powerlevel10k configuration wizard on 2022-07-21 at 16:08 WEST.
...
#    taskwarrior             # taskwarrior task count (https://taskwarrior.org/)
  ...
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%240Fâ”œâ”€'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%240Fâ•°â”€'
  # Connect right prompt lines with these symbols.
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_SUFFIX='%240Fâ”€â•®'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_SUFFIX='%240Fâ”€â”¤'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_SUFFIX='%240Fâ”€â•¯'
  ...
  # If the tracked task is longer than 24 characters, truncate and append "â€¦".
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='ïŠ’'
...
#  typeset -g POWERLEVEL9K_CONTEXT_PREFIX='%246Fwith '
  ...
  # Custom icon.
  # typeset -g POWERLEVEL9K_PERLBREW_VISUAL_IDENTIFIER_EXPANSION='â­'
  ...
  typeset -g POWERLEVEL9K_IP_CONTENT_EXPANSION='${P9K_IP_RX_RATE:+%70Fâ‡£$P9K_IP_RX_RATE }${P9K_IP_TX_RATE:+%215Fâ‡¡$P9K_IP_TX_RATE }%38F$P9K_IP_IP'
